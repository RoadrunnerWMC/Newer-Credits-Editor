...
# Everything highly specific to Newer Credits Editor is in this section,
# to make it simpler to copypaste this script across all of the
...
WIN_ICON = None
MAC_ICON = None
MAC_BUNDLE_IDENTIFIER = 'com.example.newercreditseditor'

SCRIPT_FILE = 'newer_credits_editor.py'
DATA_FOLDERS = []
